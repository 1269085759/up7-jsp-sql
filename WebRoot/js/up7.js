...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		//文件操作相关
		, "UrlCreate"		: "http://localhost:8080/Uploader7SQL/db/f_create.jsp"
		, "UrlUpdate"		: "http://localhost:8080/Uploader7SQL/db/f_update.jsp"
		, "UrlPost"			: "http://localhost:8080/Uploader7SQL/db/f_post.jsp"
		, "UrlComplete"		: "http://localhost:8080/Uploader7SQL/db/f_complete.jsp"
		, "UrlList"			: "http://localhost:8080/Uploader7SQL/db/f_list.jsp"
		, "UrlDel"			: "http://localhost:8080/Uploader7SQL/db/f_del.jsp"
	    //x86
        , ie: {
